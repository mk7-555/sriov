...
"""
Configuration parameters for Virtual Machine 2
...
if (num_ports==1):
	ip_list		= ["194.24.15.20"]
	peer_list	= peer_conf.peer_list_1port
	vlan_list	= ["202"]
	vlan_ip_list	= ["194.24.16.20"]
	vlan_peer_list	= peer_conf.vlan_peer_1port
	vm_peer_list	= ["194.24.15.20"]
	pf_ip_list	= ["194.24.15.10"]
if (num_ports==2):
	ip_list		= ["194.24.8.20", "194.24.9.20"]
	peer_list	= peer_conf.peer_list_2port
	vlan_list	= ["201", "203"]
	vlan_ip_list	= ["194.24.19.20", "194.24.20.20"]
	vlan_peer_list	= peer_conf.vlan_peer_2port
	vm_peer_list	= ["194.24.8.15", "194.24.9.15"]
	pf_ip_list	= ["194.24.8.10", "194.24.9.10"]
if (num_ports==4):
	ip_list		= ["194.24.8.20", "194.24.9.20", "194.24.6.20", "194.24.7.20"]
	peer_list	= peer_conf.peer_list_4port
	vlan_list	= ["201", "203", "208", "210"]
	vlan_ip_list	= ["194.24.19.20", "194.24.20.20", "194.24.14.20", "194.24.15.20"]
	vlan_peer_list	= peer_conf.vlan_peer_1port
	vm_peer_list	= ["194.24.8.15", "194.24.9.15", "194.24.6.15", "194.24.7.15"]
